        ...
        <>
            ...
            <aside className="hidden md:flex fixed left-0 top-0 h-screen w-60 bg-[var(--bg-card)] border-r border-[var(--border-color)] flex-col">
                <div className="p-5 border-b border-[var(--border-color)]">
                    <h1 className="text-xl font-bold bg-gradient-to-r from-[var(--accent-green)] to-[var(--accent-yellow)] bg-clip-text text-transparent tracking-tight">
                        SERENE EQ
                    </h1>
                    <p className="text-[10px] uppercase tracking-widest text-[var(--text-secondary)] -mt-0.5 opacity-80 font-semibold">AI-Powered Insights</p>
                </div>
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all group relative ${isActive
                                    ? 'bg-[var(--bg-secondary)] text-[var(--accent-green)] border-l-4 border-[var(--accent-green)] pl-2'
                            ...
                            >
                                ...
                                {isActive && (
                                    <div className="absolute right-2 w-1.5 h-1.5 rounded-full bg-[var(--accent-green)] shadow-[0_0_8px_var(--accent-green)]" />
                                )}
                            </Link>
                        );
                    })}
                ...
                <div className="p-3 border-t border-[var(--border-color)]">
                    <button
                        onClick={logout}
                        className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[var(--bg-secondary)] transition-colors w-full text-left group"
                    >
                        <LogOut size={18} className="text-[var(--text-secondary)] group-hover:text-red-400 transition-colors" />
            ...
            >
                ...
                >
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    href={item.href}
                                    onClick={() => setIsOpen(false)}
                                    className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[var(--bg-secondary)] transition-colors"
                                >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-3 border-t border-[var(--border-color)]">
                        <button
                            onClick={logout}
                            className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-[var(--bg-secondary)] transition-colors w-full text-left"
                        >
